...
export const COST_PAGE: ContentPage = {
  ...
  intro: [
    ...
    "인터넷에 표시된 금액만 비교하기보다 검사·마취·수술·약제·사후진료가 어디까지 포함되는지, 추가 비용이 생길 수 있는 조건은 무엇인지를 함께 살펴보는 것이 중요합니다.",
  ],
  hubContextLink: {
    before: "비용뿐 아니라 가능 시기와 회복 과정까지 함께 확인하려면 ",
    anchor: "임신중절수술 종합 안내",
    after: "를 참고하세요.",
  },
  ...
  keySummary: [
    { numberLabel: "01", title: "비용 결정 요소", text: "임신 주수와 진료 범위에 따라 견적 구성이 달라질 수 있습니다." },
  ...
  sections: [
    ...
    },
    {
      ...
      order: 2,
      numberLabel: "02",
      heading: "검사와 진료 방법은 비용에 어떤 영향을 주나요?",
      layout: "compare-table",
      directAnswer:
        "수술 전 검사는 임신 상태와 건강 조건을 확인하는 과정이며, 적용 가능한 진료 방법은 임신 주수·개인 상태·의료기관 판단에 따라 달라질 수 있어 비용 구성도 함께 달라질 수 있습니다.",
      paragraphs: [
    ...
    },
    {
      ...
      layout: "checklist",
      directAnswer:
        "총액 비교에 앞서 검사·마취·수술비 분리 여부, 사후진료 포함 범위, 추가 비용 가능성과 보험·본인부담 확인 경로를 정리해 두면 오해를 줄일 수 있습니다.",
      paragraphs: [
    ...
    },
    {
      ...
      order: 5,
      numberLabel: "05",
      heading: "보험 적용과 추가 비용은 어떻게 확인하나요?",
      layout: "prose",
      directAnswer:
