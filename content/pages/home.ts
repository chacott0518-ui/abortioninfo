...
export const HOME_INTRO: HomeIntro = {
  h1: "임신중절수술",
  subtitle: "임신 중절 수술 상담 전 알아야 할 정보",
  heading: "임신중절수술이란?",
  ...
  paragraphs: [
    ...
    "검색에서는 임신 중절수술이나 임신 중절 수술처럼 표현이 나뉘기도 하지만, 실제 판단은 임신 주수와 현재 상태를 확인한 뒤에 이루어집니다. 가능 여부나 비용만 비교하기보다 검사 범위, 회복 과정, 이상 증상 대응까지 함께 확인하는 것이 중요합니다.",
  ],
  summary:
...
export const HOME_INDEX: HomeIndexItem[] = [
  ...
  },
  {
    order: 3,
    numberLabel: "03",
    title: "임신중절수술 주의사항 무엇을 확인해야 하나요?",
  ...
  },
  {
    order: 4,
    numberLabel: "04",
    title: "임신중절수술 병원 어떤 기준으로 선택해야 하나요?",
  ...
  },
  {
    order: 5,
    numberLabel: "05",
    title: "임신중절수술 후기 어떤 기준으로 확인해야 하나요?",
  ...
  },
  {
    order: 6,
    numberLabel: "06",
    title: "임신중절수술 상담 전 무엇을 확인해야 하나요?",
...
export const CONTENT_CARDS: ContentCard[] = [
  {
    ...
    slug: "임신중절수술-비용",
    title: "임신중절수술 비용 어떤 기준으로 달라지나요?",
    cardTitle: "임신중절수술 비용 어떤 기준으로 달라지나요?",
    shortTitle: "임신중절수술 비용 어떤 기준으로 달라지나요?",
    cardMetaLabel: "수술비용",
    iconKey: "cost",
    description: "비용이 달라지는 기준과 상담 전 확인사항",
    cardDescription:
  ...
  },
  {
    ...
    slug: "임신중절수술-회복기간",
    title: "임신중절수술 회복기간 어떻게 확인하나요?",
    cardTitle: "임신중절수술 회복기간 어떻게 확인하나요?",
    shortTitle: "임신중절수술 회복기간 어떻게 확인하나요?",
    cardMetaLabel: "회복기간",
    iconKey: "recovery",
    description: "수술 후 회복 과정과 생활 관리",
    cardDescription:
  ...
  },
  {
    ...
    slug: "임신중절수술-주의사항",
    title: "임신중절수술 주의사항 무엇을 확인해야 하나요?",
    cardTitle: "임신중절수술 주의사항 무엇을 확인해야 하나요?",
    shortTitle: "임신중절수술 주의사항 무엇을 확인해야 하나요?",
    cardMetaLabel: "주의사항",
    iconKey: "precautions",
    description: "수술 전후 확인해야 할 주의점",
    cardDescription:
  ...
  },
  {
    ...
    slug: "임신중절수술-병원-선택",
    title: "임신중절수술 병원 어떤 기준으로 선택해야 하나요?",
    cardTitle: "임신중절수술 병원 어떤 기준으로 선택해야 하나요?",
    shortTitle: "임신중절수술 병원 어떤 기준으로 선택해야 하나요?",
    cardMetaLabel: "병원선택",
    iconKey: "hospital",
    description: "의료진·검사·사후관리 확인 기준",
    cardDescription:
  ...
  },
  {
    ...
    slug: "임신중절수술-후기",
    title: "임신중절수술 후기 어떤 기준으로 확인해야 하나요?",
    cardTitle: "임신중절수술 후기 어떤 기준으로 확인해야 하나요?",
    shortTitle: "임신중절수술 후기 어떤 기준으로 확인해야 하나요?",
    cardMetaLabel: "후기",
    iconKey: "reviews",
    description: "후기를 확인할 때 주의할 부분",
    cardDescription:
  ...
  },
  {
    ...
    title: "임신중절수술 상담 전 무엇을 확인해야 하나요?",
    cardTitle: "임신중절수술 상담 전 무엇을 확인해야 하나요?",
    shortTitle: "임신중절수술 상담 전 무엇을 확인해야 하나요?",
    cardMetaLabel: "FAQ",
    iconKey: "faq",
    description: "상담 전 자주 묻는 질문 정리",
    cardDescription:
